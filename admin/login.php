<?php 
    ...
    if(!empty($_POST['email']) && !empty($_POST['password'])) {
        ...
        if($user) {
            ...
            $_SESSION["message"] = "User Loggedin Succesfully...";
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Sparklink</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Sparklink! 👋</h4>
              <p class="mb-4">Please sign-in to your account</p>

              <?php if($error['status']) { ?>
                <p class="text-danger mb-4"><?php echo $error['message']; ?></p>
              <?php } ?>
